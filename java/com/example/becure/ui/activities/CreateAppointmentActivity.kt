...
import com.example.becure.ui.adapters.BaseAppointmentsAdapter
    ...
    private fun setupSwipeToDelete() {
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                val adapter = (binding.activity_create_appointment_recyclerview.adapter as BaseAppointmentsAdapter)
                val appointment = adapter.getAppointmentAtPosition(position)
                cancelAppointment(appointment)
            }
        }

        itemTouchHelper = ItemTouchHelper(itemTouchHelperCallback)
        itemTouchHelper.attachToRecyclerView(binding.activity_create_appointment_recyclerview)
    }
